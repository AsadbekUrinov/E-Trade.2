    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-11 d-flex align-items-center">
            <a href="#intro" class="mr-auto logo">{{$settings->site_name}}</a>
          ...
          <nav class="nav-menu d-none d-lg-block">
            ...
            <li><a href="#about">Biz haqimizda</a></li>
              ...
              <li><a href="#testimonials">Foydalanuvchilar fikri</a></li>
              </li>
              <li><a href="#contact">Biz bilan aloqa</a></li>
    
              @if($settings->site_preference =="Web dashboard only")
              @guest
              <li><a href="login" class="">Kirish</a></li>
              <li><a href="register" class="btn-log ">Boshlash</a></li>
              @else
              <li class="nav-item dropdown avatar">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg-right" aria-labelledby="navbarDropdown">
                      <a href="dashboard" class="dropdown-item text-dark">Boshqaruv Paneli</a><br>
              ...
              <li><a href="{{$settings->bot_link}}" class="btn-log ">Boshlash</a></li>
              @endif
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <a href="login" class="btn-get-started scrollto">Boshlash</a>
              </div>
            </div>
          </div>
          ...
          <form  action="{{action('App\Http\Controllers\UsersController@sendcontact')}}"  method="POST" role="form" class="contactForm">
            <div class="form-row">
              <div class="form-group col-md-6">
                <input type="text" name="name" class="form-control" id="form3" placeholder="Sizni ismingiz" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required/>
                <div class="validation"></div>
              </div>
              <div class="form-group col-md-6">
                <input type="email" class="form-control" name="email" id="form2" placeholder="Sizni Emailingiz" data-rule="email" data-msg="Please enter a valid email" required/>
                <div class="validation"></div>
              </div>
            </div>
            <div class="form-group">
              <input type="text" class="form-control" name="subject" id="subject" placeholder="Mavzu" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject"required />
              <div class="validation"></div>
            </div>
            <div class="form-group">
              <textarea class="form-control" id="form8" name="message" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Xabar matni" required></textarea>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-links">
            <h4>Sahifa linklari</h4>
            <ul>
              <li><i class="ion-ios-arrow-right scrollto"></i> <a href="#intro">Bosh sahifa</a></li>
              <li><i class="ion-ios-arrow-right"></i> <a href="#about">Biz haqimizda</a></li>
              <li><i class="ion-ios-arrow-right"></i> <a href="#services">Servis</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-4 col-md-6 footer-contact">
            ...
            <p>
              ...
              <a href="#" class="text-white"><strong>Telefon raqam:</strong> {{$content->getContent('0EXbji','description')}}<br></a>
